...
namespace AllForOne.services
{
    public class RestrauntPicker
    {
     public string RestaurantSuggestion(string category)
        ...
        string[] myfavorites = { "Misaki Toyo sushi", "Fogo De Chao", "Texas roadhouse", "L&L Hawaiian BBQ", "Nash & Tender", "Chillis", "Cheesecake Factory", "The Pho", "Sherman's Chinese Buffet" };
